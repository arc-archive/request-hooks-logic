...
declare class ActionIterableObject {
   ...
   *
   * @param opts Iterator options
   * @returns True when options are valid
   */
...
declare class JsonExtractor {
  ...
  /**
   * @param json JSON string or object. Strings are
   * parsed to objects.
   * @param path Path to the data.
   * @param iterator Data iterator
   */
  constructor(json: String|object|any[]|null, path: Array<String|null>|null, iterator: object|null);
   ...
   */
  _getValue(json: object|any[]|null, path: Array<String|null>|null, iterableOptions: object|null): String|null|undefined;
...
declare class XmlExtractor {
   ...
   * @param iterator Data iterator
   */
  constructor(xml: String|null, path: Array<String|null>|null, iterator: object|null);
